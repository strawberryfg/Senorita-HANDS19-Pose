...
const int joint_belongs_to_TIMRP[JointNum] = //21 ; belongs to each finger
{
	-1, TT, II, MM, RR, PP,
	TT, TT, TT,                    
	II, II, II,                   
...
//convenient for Homo_mat.push_back(operation_id, dof_id)
//pair first second
//if first = -1 no need to regression 4x4 rotation matrix
const int dof_operation_id[ParamNum_NYU][2] =
{
	{ -1, global_trans_x_NYU },
	{ -1, global_trans_y_NYU },
	{ -1, global_trans_z_NYU },
	{ 0, global_rot_x_NYU },
	{ 1, global_rot_y_NYU },
	{ 2, global_rot_z_NYU },
	{ -1, wrist_left_const_rot_x_NYU },
	{ -1, wrist_left_const_rot_y_NYU },
	{ -1, wrist_left_const_rot_z_NYU },
	{ -1, wrist_middle_const_rot_x_NYU },
	{ -1, wrist_middle_const_rot_y_NYU },
	{ -1, wrist_middle_const_rot_z_NYU },
	{ -1, thumb_mcp_const_rot_x_NYU },
	{ -1, thumb_mcp_const_rot_y_NYU },
	{ -1, thumb_mcp_const_rot_z_NYU },
	{ 1, thumb_pip_rot_y_NYU },
	{ 2, thumb_pip_rot_z_NYU },
	{ 2, thumb_dip_rot_z_NYU },
	{ 2, thumb_tip_rot_z_NYU },
	{ -1, little_finger_mcp_const_rot_x_NYU },
	{ -1, little_finger_mcp_const_rot_y_NYU },
	{ -1, little_finger_mcp_const_rot_z_NYU },
	{ -1, ring_finger_mcp_const_rot_x_NYU },
	{ -1, ring_finger_mcp_const_rot_y_NYU },
	{ -1, ring_finger_mcp_const_rot_z_NYU },
	{ -1, middle_finger_mcp_const_rot_x_NYU },
	{ -1, middle_finger_mcp_const_rot_y_NYU },
	{ -1, middle_finger_mcp_const_rot_z_NYU },
	{ -1, index_finger_mcp_const_rot_x_NYU },
	{ -1, index_finger_mcp_const_rot_y_NYU },
	{ -1, index_finger_mcp_const_rot_z_NYU },
	{ 0, little_finger_base_rot_x_NYU },
	{ 2, little_finger_base_rot_z_NYU },
	{ 0, little_finger_pip_rot_x_NYU },
	{ 0, little_finger_dip_rot_x_NYU },
	{ 0, ring_finger_base_rot_x_NYU },
	{ 2, ring_finger_base_rot_z_NYU },
	{ 0, ring_finger_pip_rot_x_NYU },
	{ 0, ring_finger_dip_rot_x_NYU },
	{ 0, middle_finger_base_rot_x_NYU },
	{ 2, middle_finger_base_rot_z_NYU },
	{ 0, middle_finger_pip_rot_x_NYU },
	{ 0, middle_finger_dip_rot_x_NYU },
	{ 0, index_finger_base_rot_x_NYU },
	{ 2, index_finger_base_rot_z_NYU },
	{ 0, index_finger_pip_rot_x_NYU },
	{ 0, index_finger_dip_rot_x_NYU }
};
...
//Hands2017 Challenge
const int dof_id_per_bone[BoneNum][3] =
{
	{ -1, thumb_dip_rot_y, -1 },											      //0 ttip -> tdip
	{ -1, thumb_pip_rot_y, -1 },                                                  //1 tdip -> tpip
	{ -1, thumb_mcp_rot_y, thumb_mcp_rot_z },                                     //2 tpip -> tmcp
	{ thumb_mcp_const_rot_x, thumb_mcp_const_rot_y, thumb_mcp_const_rot_z },      //3 tmcp -> wrist

	{ index_dip_rot_x, -1, -1 },                                                  //0 itip -> idip
	{ index_pip_rot_x, -1, -1 },                                                  //1 idip -> tpip
	{ index_mcp_rot_x, -1, index_mcp_rot_z },                                     //2 ipip -> imcp
	{ index_mcp_const_rot_x, index_mcp_const_rot_y, index_mcp_const_rot_z },      //3 imcp -> wrist
	
	{ middle_dip_rot_x, -1, -1 },                                                 //0 mtip -> mdip
	{ middle_pip_rot_x, -1, -1 },                                                 //1 mdip -> mpip
	{ middle_mcp_rot_x, -1, middle_mcp_rot_z },                                   //2 mpip -> mmcp
	{ middle_mcp_const_rot_x, middle_mcp_const_rot_y, middle_mcp_const_rot_z },   //3 mmcp -> wrist

	{ ring_dip_rot_x, -1, -1 },                                                   //0 rtip -> rdip
	{ ring_pip_rot_x, -1, -1 },                                                   //1 rdip -> rpip
	{ ring_mcp_rot_x, -1, ring_mcp_rot_z },                                       //2 rpip -> rmcp
	{ ring_mcp_const_rot_x, ring_mcp_const_rot_y, ring_mcp_const_rot_z },         //3 rmcp -> wrist

	{ pinky_dip_rot_x, -1, -1 },                                                  //0 ptip -> pdip
	{ pinky_pip_rot_x, -1, -1 },                                                  //1 pdip -> ppip
	{ pinky_mcp_rot_x, -1, pinky_mcp_rot_z },                                     //2 ppip -> pmcp
	{ pinky_mcp_const_rot_x, pinky_mcp_const_rot_y, pinky_mcp_const_rot_z },      //3 pmcp -> wrist

};

//NYU dataset
const int dof_id_per_bone_NYU[BoneNum_NYU][3] =
{
	{ little_finger_dip_rot_x_NYU, -1, -1},                             //0:  little_finger_dip-> tip
	{ little_finger_dip_rot_x_NYU, -1, -1},                             //1:  little_finger_pip_second -> dip
	{ little_finger_pip_rot_x_NYU, -1, -1},                             //2:  little_finger_pip_first -> pip_second
	{ little_finger_pip_rot_x_NYU, -1, -1 },                            //3:  little_finger_finger_base -> pip_first
	{ little_finger_base_rot_x_NYU, -1, little_finger_base_rot_z_NYU }, //4:  little_finger_mcp -> finger_base

	{ ring_finger_dip_rot_x_NYU, -1, -1 },                              //5:  ring_finger_dip-> tip
	{ ring_finger_dip_rot_x_NYU, -1, -1 },                              //6:  ring_finger_pip_second -> dip
	{ ring_finger_pip_rot_x_NYU, -1, -1 },                              //7:  ring_finger_pip_first -> pip_second
	{ ring_finger_pip_rot_x_NYU, -1, -1 },                              //8:  ring_finger_finger_base -> pip_first
	{ ring_finger_base_rot_x_NYU, -1, ring_finger_base_rot_z_NYU },     //9:  ring_finger_mcp -> finger_base

	{ middle_finger_dip_rot_x_NYU, -1, -1 },                            //10: middle_finger_dip-> tip
	{ middle_finger_dip_rot_x_NYU, -1, -1 },                            //11: middle_finger_pip_second -> dip
	{ middle_finger_pip_rot_x_NYU, -1, -1 },                            //12: middle_finger_pip_first -> pip_second
	{ middle_finger_pip_rot_x_NYU, -1, -1 },                            //13: middle_finger_finger_base -> pip_first
	{ middle_finger_base_rot_x_NYU, -1, middle_finger_base_rot_z_NYU }, //14: middle_finger_mcp -> finger_base 

	{ index_finger_dip_rot_x_NYU, -1, -1 },                             //15: index_finger_dip-> tip
	{ index_finger_dip_rot_x_NYU, -1, -1 },                             //16: index_finger_pip_second -> dip
	{ index_finger_pip_rot_x_NYU, -1, -1 },                             //17: index_finger_pip_first -> pip_second
	{ index_finger_pip_rot_x_NYU, -1, -1 },                             //18: index_finger_finger_base -> pip_first
	{ index_finger_base_rot_x_NYU, -1, index_finger_base_rot_z_NYU },   //19: index_finger_mcp -> finger_base

	//MCP const rot x y z
	{ global_rot_x_NYU, global_rot_y_NYU, global_rot_z_NYU },           //20: palm_center -> little_finger_mcp
	{ global_rot_x_NYU, global_rot_y_NYU, global_rot_z_NYU },           //21: palm_center -> ring_finger_mcp
	{ global_rot_x_NYU, global_rot_y_NYU, global_rot_z_NYU },           //22: palm_center -> middle_finger_mcp
	{ global_rot_x_NYU, global_rot_y_NYU, global_rot_z_NYU },           //23: palm_center -> little_finger_mcp

	{ global_rot_x_NYU, global_rot_y_NYU, global_rot_z_NYU },           //24: palm_center -> wrist_left
	{ global_rot_x_NYU, global_rot_y_NYU, global_rot_z_NYU },           //25: palm_center -> wrist_middle
	{ global_rot_x_NYU, global_rot_y_NYU, global_rot_z_NYU },           //26: palm_center -> thumb_mcp
	{ -1, thumb_pip_rot_y_NYU, thumb_pip_rot_z_NYU},                    //27: thumb_mcp -> pip
	{ -1, -1, thumb_dip_rot_z_NYU },                                    //28: thumb_pip -> dip
	{ -1, -1, thumb_tip_rot_z_NYU}                                      //29: thumb_dip -> tip
};
...
const int bones[BoneNum + 64][2] =
{
	...
	//nearby finger
	//pink -> ring
	{ptip, rtip}, {ptip, rdip}, {ptip, rpip}, {ptip, rmcp},
	{pdip, rtip}, {pdip, rdip}, {pdip, rpip}, {pdip, rmcp},
	{ppip, rtip}, {ppip, rdip}, {ppip, rpip}, {ppip, rmcp},
	{pmcp, rtip}, {pmcp, rdip}, {pmcp, rpip}, {pmcp, rmcp},
	
	//ring -> middle
	{ rtip, mtip },{ rtip, mdip },{ rtip, mpip },{ rtip, mmcp },
	{ rdip, mtip },{ rdip, mdip },{ rdip, mpip },{ rdip, mmcp },
	{ rpip, mtip },{ rpip, mdip },{ rpip, mpip },{ rpip, mmcp },
	{ rmcp, mtip },{ rmcp, mdip },{ rmcp, mpip },{ rmcp, mmcp },

	//middle -> index
	{ mtip, itip },{ mtip, idip },{ mtip, ipip },{ mtip, imcp },
	{ mdip, itip },{ mdip, idip },{ mdip, ipip },{ mdip, imcp },
	{ mpip, itip },{ mpip, idip },{ mpip, ipip },{ mpip, imcp },
	{ mmcp, itip },{ mmcp, idip },{ mmcp, ipip },{ mmcp, imcp },

	//index -> thumb
	{ itip, ttip },{ itip, tdip },{ itip, tpip },{ itip, tmcp },
	{ idip, ttip },{ idip, tdip },{ idip, tpip },{ idip, tmcp },
	{ ipip, ttip },{ ipip, tdip },{ ipip, tpip },{ ipip, tmcp },
	{ imcp, ttip },{ imcp, tdip },{ imcp, tpip },{ imcp, tmcp },
