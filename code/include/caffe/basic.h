...
//some bugs with hand model nyu layer
#include "HandModel_NYU.h"

//dataset RGB hand RDH
#include "HandModel_RDH.h"
#include "HandModel.h"
#include "CameraInfo.h"

#define select_parent_bone 0
#define select_all_pair 1
