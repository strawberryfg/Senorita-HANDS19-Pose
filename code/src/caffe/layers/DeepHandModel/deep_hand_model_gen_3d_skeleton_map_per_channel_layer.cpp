...
namespace caffe {
	...
	void DeepHandModelGen3DSkeletonMapPerChannelLayer<Dtype>::LayerSetUp(
	...
	template <typename Dtype>
	void DeepHandModelGen3DSkeletonMapPerChannelLayer<Dtype>::Reshape(
		const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
	...
	template <typename Dtype>
	void DeepHandModelGen3DSkeletonMapPerChannelLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
	...
	template <typename Dtype>
	void DeepHandModelGen3DSkeletonMapPerChannelLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
	STUB_GPU(DeepHandModelGen3DSkeletonMapPerChannelLayer);
#endif

	INSTANTIATE_CLASS(DeepHandModelGen3DSkeletonMapPerChannelLayer);
	REGISTER_LAYER_CLASS(DeepHandModelGen3DSkeletonMapPerChannel);
}
