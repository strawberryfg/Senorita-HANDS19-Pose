...
namespace caffe {
	...
	void DeepHandModelArgmaxHMLayer<Dtype>::LayerSetUp(
		const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {

	}
	template <typename Dtype>
	void DeepHandModelArgmaxHMLayer<Dtype>::Reshape(
		const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
	...
	template <typename Dtype>
	void DeepHandModelArgmaxHMLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
	...
	template <typename Dtype>
	void DeepHandModelArgmaxHMLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
	STUB_GPU(DeepHandModelArgmaxHMLayer);
#endif

	INSTANTIATE_CLASS(DeepHandModelArgmaxHMLayer);
	REGISTER_LAYER_CLASS(DeepHandModelArgmaxHM);
}
